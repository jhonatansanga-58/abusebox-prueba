            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3.5 text-sm font-medium whitespace-nowrap transition-colors border-b-2 ${activeTab === tab
...
function ServerStatusPanel({ data }) {
  ...
  return (
    <div className="grid gap-3 grid-cols-2 sm:grid-cols-3">
      <InfoCard label="IP Address" value={data.resolved_ip} copyable />
      <InfoCard label="DNS Resolved" value={data.dns_resolves ? 'Yes' : 'No'} />
      <InfoCard label="HTTP Status" value={data.status_code} />
